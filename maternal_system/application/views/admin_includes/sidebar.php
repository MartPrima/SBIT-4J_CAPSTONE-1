  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <!-- Sidebar Start -->
    <aside class="left-sidebar rounded-1 bg-home">
      <!-- Sidebar scroll-->
      <div>
        <div class="row">
          <div class="col-md-6">
        <div class="brand-logo d-flex align-items-center justify-content-between">
          <a href="../admin/dashboard" class="text-nowrap logo-img">
            <img src="../assets/images/logos/maternology.png" class="mt-4 mb-3" width="80" alt="maternology logo" />
          </a>
          <div class="col-md-6">
          <h5 class="mt-3 text-light" style="margin-left:7px">Maternology <br> System</h5>
        </div>
          ...
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="../adminhealthcenter/health_center" aria-expanded="false">
                ...
                <span class="hide-menu text-light">Health Center</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="../adminpatients/patients" aria-expanded="false">
                ...
                <span class="hide-menu text-light">Patients</span>
              </a>
            </li>
            <li class="sidebar-item">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="../adminaccountlist/acount_lists" aria-expanded="false">
                ...
                <span class="hide-menu text-light">Account List</span>
              </a>
            </li>
            <li class="nav-small-cap">
              <i class="ti ti-dots nav-small-cap-icon fs-4"></i>
