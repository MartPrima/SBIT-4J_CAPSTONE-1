  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <!-- Sidebar Start -->
    <aside class="left-sidebar bg-home rounded-1">
      <!-- Sidebar scroll-->
      <div>
        <div class="row">
          <div class="col-md-6">
        <div class="brand-logo d-flex align-items-center justify-content-between">
          <a href="../patient/dashboard" class="text-nowrap logo-img">
            <img src="../assets/images/logos/maternology.png" class="mt-4 mb-3" width="90" alt="maternology logo" />
          </a>
          <div class="col-md-6">
          <h5 class="mt-3 text-light" style="margin-left:7px"><b>Maternology <br> System</b></h5>
        </div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="../patient/dashboard" aria-expanded="false">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="./icon-tabler.html" aria-expanded="false">
                ...
                <span class="hide-menu text-light">Help Center</span>
              </a>
            </li>
            <!-- <li class="sidebar-item">
              <a class="sidebar-link" href="../patient/logout" aria-expanded="false">
                <span class="text-light">
                <i class="fas fa-sign-out-alt" style="font-size: 20px; padding-right: 3px"></i>
                </span>
