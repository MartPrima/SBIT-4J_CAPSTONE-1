        ...
        <div class="card-body">
            <div class="row mb-3">
                <div class="col-md-6 d-flex justify-content-start">
                    <h5 class="card-title fw-semibold mb-4">Patietns List</h5>
                </div>
                  ...
                  <table class="table table-bordered table-hover text-nowrap mb-0 align-middle text-center">
                    <thead class="text-dark fs-4 bg-light">
                      <tr>
                        ...
                        <th class="border-bottom-0">
                          <h6 class="fw-semibold mb-0">Health Center</h6>
                        </th>
                        <th class="border-bottom-0">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="border-bottom-0">
                          ...
                          <button type="button" class="btn btn-success btn-sm"><i class="fas fa-pencil-alt"></i></button>
                          <button type="button" class="btn btn-danger btn-sm"><i class="fas fa-archive"></i></button>
                        </td>
                      </tr> 
                      <tr>
